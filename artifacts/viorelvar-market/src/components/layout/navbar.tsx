        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <Link href="/">
            <div className="flex items-center gap-2 cursor-pointer min-w-0">
              ...
              <span className="font-bold tracking-tight truncate">Viorelvar Market</span>
            </div>
          </Link>
        </div>
    ...
    <footer className="border-t border-border/60 bg-background py-8 mt-12">
      <div className="container mx-auto px-4 text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="font-bold tracking-tight">Viorelvar Market</span>
        </div>
        <p className="text-xs text-muted-foreground">
          © {new Date().getFullYear()} Viorelvar Market · Topup digital paling kilat di Indonesia
        </p>
